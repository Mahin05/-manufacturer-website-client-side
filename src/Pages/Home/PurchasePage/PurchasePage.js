...
const PurchasePage = () => {
    ...
    useEffect(() => {
        const url = `https://manufacturer-website-server-side-zd8v.onrender.com/purchase/${toolId}`;
        fetch(url)
            .then(res => res.json())
    ...
    const handleOrder = event => {
        ...
        fetch('https://manufacturer-website-server-side-zd8v.onrender.com/order',{
            method:'POST',
            headers:{
